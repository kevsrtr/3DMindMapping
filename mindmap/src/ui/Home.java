...
public class Home extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		...
		//make unnecessary buttons disable
		...
		saveAlert = new Alert(AlertType.CONFIRMATION);
		saveAlert.setTitle(null);
		saveAlert.setHeaderText(null);
		saveAlert.initStyle(StageStyle.UNDECORATED);
		//save button info
		...
		saveButton.setOnAction(e -> {
			saveAlert.setContentText("Save the note: " + currentNote.getName());
	...
	public VBox addVideo() throws URISyntaxException {
		...
		play.setOnAction(e ->{
			Thread playThread = new Thread(() -> mp.play());
